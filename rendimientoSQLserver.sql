...
CREATE INDEX IX1 ON [MillionsDB].[dbo].[FakeTable](Office)
DROP INDEX IX1 ON [MillionsDB].[dbo].[FakeTable]
-- --------------------------------------------------------
...
CREATE INDEX IX1 ON [MillionsDB].[dbo].[FakeTable](Office) INCLUDE([Name],[DayOfBirth])